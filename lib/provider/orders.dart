...
class Orders with ChangeNotifier {
  ...
  Future<void> addOrder(List<CartItem> cartProducts, double amount) async {
    var url = 'https://shopapp1-8b039.firebaseio.com/orders/$userId.json?auth=$authToken';
  ...
  Future<void> getAndSetOrders() async {
    final url = 'https://shopapp1-8b039.firebaseio.com/orders/$userId.json?auth=$authToken';
